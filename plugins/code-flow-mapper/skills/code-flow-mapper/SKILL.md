...
Mapear a **árvore de execução bidirecional** de um ponto de entrada no código, para que o usuário entenda exatamente como a funcionalidade acontece antes de alterá-la. A pergunta que esta skill responde é: *"Como esse pedaço de código executa, e o que mais preciso revisar quando eu mexer nele?"*
